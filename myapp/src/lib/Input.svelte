<script lang="ts">
    ...
    let classes = "placeholder:opacity-0 peer transition shadow-black/5 ring-1 ring-slate-700/10 rounded-md w-full pb-2 pt-5 px-4 bg-slate-100 leading-tight focus:outline"
</script>
